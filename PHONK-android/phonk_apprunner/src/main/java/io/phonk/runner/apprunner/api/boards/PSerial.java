...
public class PSerial extends ProtoBase {
    ...
    private final String TAG = PSerial.class.getSimpleName();
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                //                != 0x0003) && deviceVID != 0x5c6 && devicePID != 0x904c) {
        ...
        public void run() {
            ...
            if (mSerialPort != null) {
                if (mSerialPort.open()) {
                    ...
                    //
                    // Some Arduinos would need some sleep because firmware wait some time to know whether a new
                    // sketch is going
