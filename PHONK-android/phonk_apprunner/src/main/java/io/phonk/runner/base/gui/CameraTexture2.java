...
public class CameraTexture2 extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private static final int STATE_WAITING_NON_PRECAPTURE = 3; //waiting for the exposure state to be something other
    // than precapture
    ...
    private static Size chooseOptimalSize(
            Size[] choices, int textureViewWidth, int textureViewHeight, int maxWidth, int maxHeight, Size aspectRatio
    ) {
